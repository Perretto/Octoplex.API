...
//using Octoplex.Pedidos.WebAPI.Extensions;
using MediatR;
...
builder.Services.AddMediatR(typeof(PedidoCommand));
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Octoplex.Pedidos.WebAPI", Version = "v1" });
...
//builder.Services.UseDbContext<PedidoDbContext>(builder.Configuration);
