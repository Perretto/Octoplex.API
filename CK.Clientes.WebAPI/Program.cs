...
using Octoplex.Clientes.Infra.Data.Clientes;
using Octoplex.Clientes.WebAPI.Extensions;
using MediatR;
...
builder.Services.AddMediatR(typeof(ClienteCommand));
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CK.Clientes.WebAPI", Version = "v1" });
...
builder.Services.UseDbContext<ClienteDbContext>(builder.Configuration);
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "CK.Clientes.WebAPI v1");
    });
}
